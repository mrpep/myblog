...
{{< figure src="images/loss_librilight.png" title="Training and validation loss in Librilight" >}}

### Generations

#### Example 1
{{< music url="audio/zuckerberg_prompt.wav" name="Prompt" artist="Unknown">}}
{{< music url="audio/zuckerberg_04T.wav" name="Generated with T=0.4" artist="Unknown">}}
{{< music url="audio/zuckerberg_gen2.wav" name="Generated with T=0.6" artist="Unknown">}}
{{< music url="audio/zuckerberg_gen1.wav" name="Generated with T=0.8" artist="Unknown">}}



#### Example 2
{{< music url="audio/scarlett_prompt.wav" name="Prompt" artist="Unknown">}}
{{< music url="audio/scarlett_gen2.wav" name="Generated with T=0.6" artist="Unknown">}}
{{< music url="audio/scarlett_gen1.wav" name="Generated with T=0.8" artist="Unknown">}}
...
generate sometimes some words or 'word-like' sounds. The prosody and rhythm of speaking sounds quite coherent too. However the audio quality is not the best as 
some artifacts can be heard.
...
{{< music url="audio/zuckerberg_heating.wav" name="Heating from 0.01 to 2" artist="Unknown">}}
...
{{< music url="audio/scarlett_prompt.wav" name="Prompt 2" artist="Unknown">}}
{{< music url="audio/zuckerberg_to_scarlett_shorter.wav" name="Short interpolation" artist="Unknown">}}
{{< music url="audio/zuckerberg_to_scarlett.wav" name="Long interpolation" artist="Unknown">}}
